...
<head>
    ...
    <title>Vote Result | FMS Online Voting System</title>
    ...
    <link rel="apple-touch-icon-precomposed" href="images/ico/apple-touch-icon-57-precomposed.png">
        ...
        <link href="https://fonts.googleapis.com/css2?family=Prompt:wght@100;300;400;700;900&display=swap" rel="stylesheet">  
            <style>
                 li, input, .title, .title-desc, .btn {font-family: 'Prompt';}
                 .text-block {
            position: absolute;
            bottom: 20px;
            right: 20px;
        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            <h1 style="color :white" class="title">ผลการลงคะแนนโหวต/Vote Result</h1>
                            <p class="title-desc">
                            </p>
                        </div>
                    </div>
                ...
                <div class="portfolio-items">
                        ...
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb logo-image">
                                    <img src="images/candidate/1.png" class="img-responsive" alt="">
                    ...
                    <div class="col-sm-4 portfolio-item mockup folio">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb logo-image">
                                    <img src="images/candidate/2.png" class="img-responsive" alt="">
                    ...
                    <div class="col-sm-4 portfolio-item mockup folio">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb logo-image">
                                    <img src="images/candidate/3.png" class="img-responsive" alt="">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <canvas id="chart-vote-major" height="250" width="auto"></canvas>
                </div>
            </div>
            <div class="row">
